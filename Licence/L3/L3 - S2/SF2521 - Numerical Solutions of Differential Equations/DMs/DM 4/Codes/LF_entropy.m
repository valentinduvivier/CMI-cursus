    ...
    % Conditions : initial and boundary
        ...
        for t = 1:iter_t
            ...
            % Reflecting boundary for the height + boundary for the moment
                u(1,1) = 2*u(1,2) - u(1,3);    u(1,n+2) = 0.8;
                
                u(2,1) = Inflow_condition;   u(2,n+2) = 2*u(2,n+1) - u(2,n);            
