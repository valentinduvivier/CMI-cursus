...
%     - each major question using Matlab as its own section ;
%     - you should still run them in the order of appearance
%     to make shure every variable are computed at least once though ;
% 
...
M = 30; N = 30;   % Number of point considered for the discretization
