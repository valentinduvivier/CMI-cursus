...
FLoad  = 0 + .5*rho_w*g*h    # [N]
Weight = -1*rho_c*g

# Geometry description and mesh generation
mesh, boundary = call_gmsh('geometry/GeometryDam_T6.geo', SolidT6)
...
nbFig = list_res.treat_stress(mesh, coeff, U, model, analysis_type, nbFig, Yg_mod, Nu_poi)
