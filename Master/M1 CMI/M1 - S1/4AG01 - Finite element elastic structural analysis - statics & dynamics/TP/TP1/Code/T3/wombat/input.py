...
def call_gmsh(geofile,elem_type):
    ...
    # Example (RC)
    #command = '~/Downloads/gmsh-4.7.1-Windows64/gmsh -order'+str(order)+' '+geofile+' -2'  
    command = 'C:\\Users\\vltn0\\Downloads\\gmsh-4.7.1-Windows64\\gmsh.exe -order '+str(order)+' '+geofile+' -2'
