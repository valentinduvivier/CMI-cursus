...
class ExtForce:
    ...
    def add_volume_forces(self,el_list_vol,fx=[],fy=[],cz=[]):
        """ Adds a uniformly volume force to a list of elements"""
    ...
    # # def add_heterogeneous_distributed_forces(self,el_list_het,fx=[],fy=[],cz=[]):
    # #     """ Adds a heterogeneous distributed force to a list of elements"""
        
    #     if isinstance(el_list_vol,ElementGroup):
    #         el_list_het = el_list_het.elem_list
            
    #     if not isinstance(el_list_het, list): el_list_het = [el_list_het]
        
    #     self.el_list_het += el_list_het
        
    #     self.fx_eh += append_component(fx,len(el_list_het))
    #     self.fy_eh += append_component(fy,len(el_list_het))
    #     self.cz_eh += append_component(cz,len(el_list_het))
